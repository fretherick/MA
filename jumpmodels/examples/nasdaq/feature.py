...
"""
from jumpmodels.examples.nasdaq.utils_dir import *
# from jumpmodels.exutils_dir import *
include_home_dir()
...
from jumpmodels.jumpmodels.utils import *
...
class DataLoader(BaseEstimator):
    ...
    def load(self, start_date: DATE_TYPE = None, end_date: DATE_TYPE = None):
        ...
        ret_ser_raw = pd.read_pickle(f"{curr_dir}/data/{self.ticker}.pkl").dropna()
